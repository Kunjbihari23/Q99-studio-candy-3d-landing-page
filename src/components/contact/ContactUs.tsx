      ...
      <div className="container-custom relative z-10 py-10 flex flex-col items-center text-center">
        ...
        <div className="flex flex-wrap items-center justify-center gap-14 mt-20 px-4">
          ...
          <button
            ...
            className="group relative sm:px-14 sm:py-6 cursor-pointer transition-all duration-300 active:scale-95 hover:scale-105"
          >
            {/* Main Surface */}
            <div className="relative px-10 py-4 sm:px-14 sm:py-6 rounded-[2.5rem] bg-[#b01c7d] border-t-4 border-white/30 border-l-2 border-white/10 overflow-hidden shadow-[0_10px_30px_rgba(176,28,125,0.4)]">
          ...
          >
            {/* Main Surface */}
            <div className="relative px-10 py-4 sm:px-14 sm:py-6 rounded-[2.5rem] bg-[#92cc41] border-t-4 border-white/50 border-l-2 border-white/20 overflow-hidden shadow-[0_10px_30px_rgba(146,204,65,0.4)]">
